import { Badge, Layout, Menu, Breadcrumb } from "antd";
                        ...
                        {subitem.children.map((nestSubItem, index) => {
                          ...
                          return (
                            ...
                            >
                              <Link
                                href={`${
                                  nestSubItem.path ? nestSubItem.path : ""
                                }`}
                                prefetch
                              >
                                <a>
                                  ...
                                  {nestSubItem.badge &&
                                    badgeTemplate(nestSubItem.badge)}
                                </a>
                              </Link>
                            </Menu.Item>
                          );
      ...
      <Layout style={{ minHeight: "100vh" }}>
        ...
        <Layout>
          ...
          <Content style={{ margin: "0 16px" }}>
            ...
            <div
              style={{ padding: 24, background: "#fff", minHeight: "90%" }}
              className="example-sass"
            >
              {children}
            </div>
          </Content>
